...
from bp_includes.lib.decorators import access_token_required
from bp_includes.lib import captcha, utils
import bp_includes.models as models_boilerplate
import forms as forms
# Alfresco & CMIS stuff
from bp_includes.external.cmislib.model import CmisClient
import urllib2
import urllib
...
class SecureRequestHandler(BaseHandler):
    ...
    def get(self, **kwargs):
        ...
        #alfresco_user=self.user_model()
        user_info = self.user_model.get_by_id(long(self.user_id))
        user_info_object = self.auth.store.user_model.get_by_auth_token(
            user_session['user_id'], user_session['token'])
        
        # Get Alfresco Repository Info
        access_token=self.session["alfresco_access_token"]
        headers = {'Authorization': 'Bearer ' + access_token}
        client = CmisClient('https://api.alfresco.com/cmis/versions/1.1/atom', '', '', headers=headers)
        # Todo , get by configuration
        repo = client.getRepository('alfresco.com') 
        
        # Get a Network info
        url='https://api.alfresco.com/yourcompany.com/public/alfresco/versions/1/networks/alfresco.com'
        myUrlParams=urllib
        ...
        try:
            params = {
                ...
                "repository_info": repo.getRepositoryInfo(),
                "access_token": access_token,
            }
            return self.render_template('information.html', **params)
        except (AttributeError, KeyError), e:
    ...
    def post(self, **kwargs):
        ...
        try:
            ...
            try:
                ...
                if user:
                    # Delete Social Login
                    for alfresco_user in models_boilerplate.AlfrescoUser.get_by_user(user_info.key):
                        alfresco_user.key.delete()
